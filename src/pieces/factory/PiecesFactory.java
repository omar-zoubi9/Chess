...
import pieces.*;
import moveBehavior.normalValidationTypes.*;

public class PiecesFactory implements IPiecesFactory {
    ...
    public ChessPiece makeWhiteChessPiece(String pieceType){
        return makeChessPiece(pieceType , 1);
    }
    public ChessPiece makeBlackChessPiece(String pieceType){
        return makeChessPiece(pieceType , 2);
    }
    @Override
    ...
    @Override
    public King makeWhiteKing() {
        return new King(1 , KingMoveValidator.getInstance());
    }
    @Override
    public King makeBlackKing() {
        return new King(2 , KingMoveValidator.getInstance());
    }
    @Override
    ...
    public Rook makeWhiteRook(){return new Rook(1 , RookMoveValidator.getInstance()); }
